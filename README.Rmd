...
> Frerebeau, N., Ben Amara, A. et Cantin, N. (2020). Analyse de données et identification des altérations géochimiques des matériaux céramiques : le cas des productions d'un atelier ibérique (Teruel, Espagne ; IIe-Ier millénaire avant J.-C.). *Archéosciences, revue d'Archéométrie*, X, p. X-X. DOI : <https://doi.org/xxx/xxx>.
